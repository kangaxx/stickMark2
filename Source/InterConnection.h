...
#ifndef JUCE_INTERPROCESSCONNECTION_H_INCLUDED_
#define JUCE_INTERPROCESSCONNECTION_H_INCLUDED_
...
public:
    ...
    */
    InterConnection (bool callbacksOnMessageThread = false,
    ...
    */
    ...
    /** Tries to connect the object to an existing named pipe.
        ...
        an InterConnection object and used createPipe() to create a pipe for this
        to connect to.
    ...
    */
	...
	bool sendMessage_Old (const MemoryBlock& message);
...
private:
    //==============================================================================
    WeakReference<InterConnection>::Master masterReference;
    friend class WeakReference<InterConnection>;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (InterConnection)
};

#endif   // JUCE_INTERPROCESSCONNECTION_H_INCLUDED_
